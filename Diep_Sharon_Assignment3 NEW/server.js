...
var productdata = require("./public/product_data.js"); //accessing data from javascript file
...
app.post("/register_user", function (request, response) {
  ...
  //add errors to querystring (for purpose of putting back into textbox)
    ...
    console.log(errors);
    res.redirect('./registration.html?' + theQuantQuerystring) //trying to add query from registration page and invoice back to register page on reload
  }
}
);
